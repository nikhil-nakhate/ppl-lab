...
let reservedWords = [
  ...
  ("isweekday", fun i -> Parser.ISWEEKDAY i);
  ("nextweekday", fun i -> Parser.NEXTWEEKDAY i);
  ("monday", fun i -> Parser.MONDAY i);
  ("tuesday", fun i -> Parser.TUESDAY i);
  ("wednesday", fun i -> Parser.WEDNESDAY i);
  ("thursday", fun i -> Parser.THURSDAY i);
  ("friday", fun i -> Parser.FRIDAY i);
  ("saturday", fun i -> Parser.SATURDAY i);
  ("sunday", fun i -> Parser.SUNDAY i);
  ("weekday", fun i -> Parser.WEEKDAY i);
  ("weekend", fun i -> Parser.WEEKEND i);
