...
%token <Support.Error.info> ISWEEKDAY
%token <Support.Error.info> NEXTWEEKDAY
%token <Support.Error.info> MONDAY
%token <Support.Error.info> TUESDAY
%token <Support.Error.info> WEDNESDAY
%token <Support.Error.info> THURSDAY
%token <Support.Error.info> FRIDAY
%token <Support.Error.info> SATURDAY
%token <Support.Error.info> SUNDAY
%token <Support.Error.info> WEEKDAY
%token <Support.Error.info> WEEKEND
