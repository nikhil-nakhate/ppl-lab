...
%token <Support.Error.info> FIRST
%token <Support.Error.info> SECOND
%token <Support.Error.info> NATPAIR
%token <Support.Error.info> BOOLPAIR
...
Term :
  ...
  | PAIR LPAREN Term COMMA Term RPAREN
      { TmPair($1, $3, $5) }
  | FIRST LPAREN Term COMMA Term RPAREN
      { TmFirst($1, $3, $5) }
  | SECOND LPAREN Term COMMA Term RPAREN
      { TmSecond($1, $3, $5) }
